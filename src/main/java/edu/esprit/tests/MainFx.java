...
//        FXMLLoader loader= new FXMLLoader(getClass().getResource("/demandeReservation.fxml"));
//        FXMLLoader loader= new FXMLLoader(getClass().getResource("/historiqueReservation.fxml"));
